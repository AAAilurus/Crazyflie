...
from .lqr_position_controller import LQRPositionController
...
class ControllerPID:
    """Main USC controller with LQR outer-loop position control"""
    ...
    def __init__(self):
        ...
        self.position_controller: Optional[LQRPositionController] = None
    ...
    def init(self):
        ...
        self.position_controller = LQRPositionController()
