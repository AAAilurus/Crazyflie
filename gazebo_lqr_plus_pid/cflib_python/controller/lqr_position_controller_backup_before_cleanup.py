...
class LQRPositionController:
    ...
    def position_controller(self, setpoint: Setpoint, state: State) -> Tuple[float, Attitude]:
        ...
        # Safety test 1:
        # Use physical LQR only for vertical z control first.
        # Keep roll/pitch zero so we can verify the thrust channel.
        roll_cmd = 0.0
        pitch_cmd = 0.0
        az_cmd = float(u[2])
        ...
        # Keep yaw handled by controller_lqr_position.py
