...
class LQRPositionController:
    ...
    def __init__(self):
        ...
        self.max_roll_rad = math.radians(PID_VEL_ROLL_MAX)
        self.max_pitch_rad = math.radians(PID_VEL_PITCH_MAX)
        self.max_az = 15.0
    ...
    def position_controller(self, setpoint: Setpoint, state: State) -> Tuple[float, Attitude]:
        ...
        # Vertical-flight mode used for the takeoff-hover-landing experiment.
        # The LQR vertical channel controls altitude through az_cmd.
        # Roll and pitch are held at zero for this stable vertical demo.
        roll_cmd = 0.0
        pitch_cmd = 0.0
        az_cmd = float(u[2])
